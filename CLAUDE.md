...
- `À faire` E12.23 [P] OCR artifact correction: post-OCR cleanup of multi-column mixing (RapidOCR reading order), minor artifacts (I'homme → l'homme). Heuristic reordering or LLM-based correction. RapidOCR confirmed best OCR engine for French fidelity (2026-09-15 comparison). See docs/studies/ocr-comparison-2026-09-15.md
