...
- `À faire` E12.44 [P] Configurable timeout per model in LLM registry: add `timeout` field to llm registry entries. Used by PictureDescriptionApiOptions and caption_with_docling. Default 180s. Molmo CPU needs 600s for PPTX images
