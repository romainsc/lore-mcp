...
- `Prêt` E12.42 [P] Multi-model via Docling natif: parse once → save_as_json → pour chaque modèle: load + PictureDescriptionApiModel → export. Zéro code VLM custom. Vérifié: images survivent à la sérialisation JSON. See docs/studies/grooming-E12.42.md
