...
- `Prêt` E10.15 [P] RAGAS scoring wired. Retrieval metrics (hit/mrr/word_overlap) OK. Embedding metrics and RAGAS metrics not passed through from config to evaluate_retrieval in run_optimize/run_build.
