...
- `Prêt` E12.35 [P] Caption quality gate + judge robustness: detect repetition loops in VLM output (discard), keep phase2 files for diagnosis, improve judge prompt (anti-repetition, prefer completeness, prefer source language). See docs/studies/grooming-E12.35.md
