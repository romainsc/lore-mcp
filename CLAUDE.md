...
- `À faire` E12.36 [P] Enrichment in source language: add document language to enrichment prompt so granite-8b produces Q&A/context in FR for FR sources, not EN
